//g++ -I/Users/eita/boost_1_63_0 -I/Users/eita/Dropbox/Research/Tool/All/ HMM_ViterbiEstimation_v181023.cpp -o HMM_ViterbiEstimation
#include<fstream>
#include<iostream>
#include<cmath>
#include<string>
...
int main(int argc, char** argv){
	...
	if(argc!=4){
		cout<<"Error in usage: $./this param.txt dataFile.txt result.txt"<<endl;
		return -1;
	}//endif
	string paramFile=string(argv[1]);
	string dataFile=string(argv[2]);
	string resultFile=string(argv[3]);
